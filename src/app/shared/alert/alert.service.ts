...
export class AlertService
{
    ...
    public static success(title: string, message: string, action?: string): Observable<VAlertAction>
    {
        const alert = new VAlert('success', title, message, action);
    ...
    // tslint:disable-next-line: member-ordering
    public static error(title: string, message: string, action?: string): Observable<VAlertAction>
    {
        const alert = new VAlert('error', title, message, action);
        AlertService._instance.addAlert(alert);
    ...
    // tslint:disable-next-line: member-ordering
    public static info(title: string, message: string, action?: string): Observable<VAlertAction>
    {
        const alert = new VAlert('info', title, message, action);
        AlertService._instance.addAlert(alert);
    ...
    // tslint:disable-next-line: member-ordering
    public static warn(title: string, message: string, action?: string): Observable<VAlertAction>
    {
        const alert = new VAlert('warning', title, message, action);
        AlertService._instance.addAlert(alert);
    ...
    // tslint:disable-next-line: member-ordering
    public static confirm(title: string, message: string, action?: string): Observable<VAlertAction>
    {
        const alert = new VAlert('confirm', title, message, action);
        AlertService._instance.addAlert(alert);
